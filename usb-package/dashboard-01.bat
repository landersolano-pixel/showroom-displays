@echo off
title Dashboard Kiosk - Estacion 01
cd /d "%~dp0"
...
if exist "%~dp001_recepcion.html" (
    copy "%~dp001_recepcion.html" "C:\Dashboards\01_recepcion.html" /Y >nul 2>&1
)
...
if not errorlevel 1 (
    set "URL=https://landersolano-pixel.github.io/showroom-displays/01_recepcion.html"
) else (
    if exist "C:\Dashboards\01_recepcion.html" (
        set "URL=file:///C:/Dashboards/01_recepcion.html"
    )
)
