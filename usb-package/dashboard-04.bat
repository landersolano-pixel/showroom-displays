@echo off
title Dashboard Kiosk - Estacion 04
cd /d "%~dp0"
...
if exist "%~dp004_trazabilidad.html" (
    copy "%~dp004_trazabilidad.html" "C:\Dashboards\04_trazabilidad.html" /Y >nul 2>&1
)
...
if not errorlevel 1 (
    set "URL=https://landersolano-pixel.github.io/showroom-displays/04_trazabilidad.html"
) else (
    if exist "C:\Dashboards\04_trazabilidad.html" (
        set "URL=file:///C:/Dashboards/04_trazabilidad.html"
    )
)
