@echo off
title Dashboard Kiosk - Estacion 03
cd /d "%~dp0"
...
if exist "%~dp003_instantmes.html" (
    copy "%~dp003_instantmes.html" "C:\Dashboards\03_instantmes.html" /Y >nul 2>&1
)
...
if not errorlevel 1 (
    set "URL=https://landersolano-pixel.github.io/showroom-displays/03_instantmes.html"
) else (
    if exist "C:\Dashboards\03_instantmes.html" (
        set "URL=file:///C:/Dashboards/03_instantmes.html"
    )
)
