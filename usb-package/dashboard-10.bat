@echo off
title Dashboard Kiosk - Estacion 10
cd /d "%~dp0"
...
if exist "%~dp010_dashboard_ejecutivo.html" (
    copy "%~dp010_dashboard_ejecutivo.html" "C:\Dashboards\10_dashboard_ejecutivo.html" /Y >nul 2>&1
)
...
if not errorlevel 1 (
    set "URL=https://landersolano-pixel.github.io/showroom-displays/10_dashboard_ejecutivo.html"
) else (
    if exist "C:\Dashboards\10_dashboard_ejecutivo.html" (
        set "URL=file:///C:/Dashboards/10_dashboard_ejecutivo.html"
    )
)
