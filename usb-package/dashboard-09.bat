@echo off
title Dashboard Kiosk - Estacion 09
cd /d "%~dp0"
...
if exist "%~dp009_edge_iot_gateway.html" (
    copy "%~dp009_edge_iot_gateway.html" "C:\Dashboards\09_edge_iot_gateway.html" /Y >nul 2>&1
)
...
if not errorlevel 1 (
    set "URL=https://landersolano-pixel.github.io/showroom-displays/09_edge_iot_gateway.html"
) else (
    if exist "C:\Dashboards\09_edge_iot_gateway.html" (
        set "URL=file:///C:/Dashboards/09_edge_iot_gateway.html"
    )
)
