@echo off
title Dashboard Kiosk - Estacion 08
chcp 65001 >nul
...
if exist "%~dp008_ecosistema.html" (
    copy "%~dp008_ecosistema.html" "C:\Dashboards\08_ecosistema.html" /Y >nul 2>&1
)
...
if %errorlevel%==0 (
    set "URL=https://landersolano-pixel.github.io/showroom-displays/08_ecosistema.html"
) else (
    if exist "C:\Dashboards\08_ecosistema.html" (
        set "URL=file:///C:/Dashboards/08_ecosistema.html"
    ) else (
