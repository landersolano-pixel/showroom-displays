@echo off
title Dashboard Kiosk - Estacion 06
chcp 65001 >nul
...
if exist "%~dp006_calidad.html" (
    copy "%~dp006_calidad.html" "C:\Dashboards\06_calidad.html" /Y >nul 2>&1
)
...
if %errorlevel%==0 (
    set "URL=https://landersolano-pixel.github.io/showroom-displays/06_calidad.html"
) else (
    if exist "C:\Dashboards\06_calidad.html" (
        set "URL=file:///C:/Dashboards/06_calidad.html"
    ) else (
