@echo off
title Dashboard Kiosk - Estacion 02
chcp 65001 >nul
...
if exist "%~dp002_digital_factory.html" (
    copy "%~dp002_digital_factory.html" "C:\Dashboards\02_digital_factory.html" /Y >nul 2>&1
)
...
if %errorlevel%==0 (
    set "URL=https://landersolano-pixel.github.io/showroom-displays/02_digital_factory.html"
) else (
    if exist "C:\Dashboards\02_digital_factory.html" (
        set "URL=file:///C:/Dashboards/02_digital_factory.html"
    ) else (
